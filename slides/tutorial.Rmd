...
- Currently (July 2020) learnr gives a warning if the exercise code chunk produces an invisible result, e.g. code chunk makes an assignment instead of outputting a result -- this should be fixed in the next learnr release [[PR]](https://github.com/rstudio/learnr/pull/373)
