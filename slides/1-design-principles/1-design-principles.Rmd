...
subtitle: "`r emo::ji('cake')` start with cake! <br> `r emo::ji('link')` [rstd.io/rit](http://rstd.io/rit)"
...
.your-turn[
- Go to [rstd.io/rit-cloud](https://rstd.io/rit-cloud) to join the RStudio Cloud workspace for this workshop. (You can log in with Google, GitHub, shinyapps.io or create a new account.)
- When you get to the Welcome page, click on Projects on the top left.
