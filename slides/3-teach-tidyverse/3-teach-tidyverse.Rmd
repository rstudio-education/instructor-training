---
title: "> 3 <br> > teaching the tidyverse"
subtitle: "`r emo::ji('broom')` tidy up your teaching! <br> `r emo::ji('link')` [rstd.io/rit](https://rit)"
...
- The third argument, `names_to`, is a string specifying the name of the variable to create from column names of data
- The fourth argument, `values_to`, is a string specifying the name of the variable to create from the data stored in cell values
